...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/deleted-products', [AdminController::class, 'deletedProducts'])->name('admin.products.deleted');
    Route::put('/products/{id}/restore', [AdminController::class, 'restoreProduct'])->name('admin.products.restore');
...
Route::middleware(['auth', 'role:officer'])->prefix('officer')->group(function () {
    ...
    Route::get('/deleted-products', [AdminController::class, 'deletedProducts'])->name('officer.products.deleted');
    Route::put('/products/{id}/restore', [AdminController::class, 'restoreProduct'])->name('officer.products.restore');
